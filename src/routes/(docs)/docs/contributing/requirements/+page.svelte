	...
	<svelte:fragment slot="bcu-docs-detail">
		<section class="flex flex-col gap-10">
			...
			<header class="space-y-4">
				<h1>Requirements</h1>
				<p>
					If you wish to contribute to BlackCatUI, please ensure you have read and understand our
					requirements below.
				</p>
			</header>
			...
			<section class="space-y-4">
				...
				<aside class="bcu-alert variant-ghost-warning">
					<Icon src={HandThumbUp} class="w-8" />
					<div class="bcu-alert-message">
						Remember to be a team player, don't be a hero! Open-source is most successful when we
						work together.
					</div>
				</aside>
				<ol class="list-decimal list-inside space-y-1">
					<li>
						<a
							href="https://github.com/codingcatdev/blackcatui/issues"
							target="_blank"
							rel="noreferrer">Select an issue</a
						>
						or
						<a
							href="https://github.com/orgs/CodingCatDev/discussions/414"
							target="_blank"
					...
					<li>
						...
						>, or
						<a href="https://discord.com/invite/vM2bagU" target="_blank" rel="noreferrer"
							>reach out on Discord</a
						>.
					</li>
					<li>
						Review with core contributors to define <strong>all requirements</strong> before you write
						your first line of code.
					</li>
					<li>Follow our <strong>branch naming conventions</strong> described below.</li>
					<li>
						Don't be afraid to submit a <strong>draft pull request</strong> early on to ensure you're
						meeting our guidelines.
					</li>
				...
				Document your new feature or update per our <a href="/docs/contributing/documentation" target="_blank" rel="noreferrer"> documentation guidelines</a>.
					...
					<li>
						When ready, set your pull request to the "ready to review" state. Then be patient, we'll
						review asap.
					</li>
					<li>
						If your PR meets all requirements it will be merged, otherwise feedback will be
						provided.
					</li>
				</ol>
			</section>
			...
			<section class="space-y-4">
				...
				<p>
					The wildcards (*) should be replaced with short and semantic descriptions that are
					lowercase and seperated by dashes.
				</p>
			...
			<section class="space-y-4">
				...
				<p>
					Avoid adding additional depedencies without prior consent from a core team member. Pull
					Requests that do not follow this recommendation will be rejected outright.
				</p>
			</section>
			...
			<section class="space-y-4">
				...
				<p>
					All BlackCatUI projects utilize <a
						href="https://prettier.io/"
						target="_blank"
						rel="noreferrer">Prettier</a
			...
			<section class="space-y-4">
				...
				<p>
					Tests are handled via <a href="https://vitest.dev/" target="_blank" rel="noreferrer"
						>Vitest</a
					>, which is similar to Jest. Ensure tests are current and passing before submitting a pull
					request.
				</p>
