<script lang="ts">
	...
	// Components
	import Paginator from '$lib/components/DataDisplay/Paginator/Paginator.svelte';
	...
	// Types
	import type { PaginationSettings } from '$lib/components/DataDisplay/Paginator/types';
	// Sveld
	import sveldPaginator from '$lib/components/DataDisplay/Paginator/Paginator.svelte?raw&sveld';
...
<Table source={{ head: tableHeaders, body: paginatedSource }} />
		...
		<div class="space-y-4">
			...
			<p>
				Use the <code>page</code> and <code>amount</code> events to notify your server of pagination
				updates.
			</p>
			<CodeBlock
				language="ts"
