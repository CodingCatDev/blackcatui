...
<DocsShell {settings}>
	<section class="flex flex-col gap-10">
		...
		<div class="space-y-4">
			<h2>Selection</h2>
			<p>
				Selection color is also set via a token class. Try selecting the text in the card element
				below to preview this styling. Notice how selection color changes depending on the
				background.
			</p>
		...
		<div class="space-y-4">
			...
			<DocsPreview background="neutral">
				<svelte:fragment slot="bcu-previewer-preview">
					<button class="bcu-button variant-soft">Tap Me</button>
				</svelte:fragment>
				<svelte:fragment slot="bcu-previewer-source">
					<CodeBlock
						language="css"
		...
		<div class="space-y-4">
			<h2>Scrollbars</h2>
			<p>
				Skeleton automatically provides custom scrollbar styles in supported browsers. Use <code
					>.hide-scrollbar</code
			...
			<DocsPreview background="neutral">
				<svelte:fragment slot="bcu-previewer-preview">
					<div class="card p-4 max-h-[200px] overflow-auto space-y-4">
						...
						<p>
							Lorem ipsum, dolor sit amet consectetur adipisicing elit. Culpa corrupti iusto dolor.
							Similique quibusdam eveniet quae deleniti architecto modi natus, quos ducimus!
							Repudiandae reiciendis totam sequi veniam necessitatibus, magni harum. Lorem ipsum,
							dolor sit amet consectetur adipisicing elit. Culpa corrupti iusto dolor. Similique
							quibusdam eveniet quae deleniti architecto modi natus, quos ducimus! Repudiandae
							reiciendis totam sequi veniam necessitatibus, magni harum. Lorem ipsum, dolor sit amet
							consectetur adipisicing elit. Culpa corrupti iusto dolor. Similique quibusdam eveniet
							quae deleniti architecto modi natus, quos ducimus! Repudiandae reiciendis totam sequi
							veniam necessitatibus, magni harum. Lorem ipsum, dolor sit amet consectetur
							adipisicing elit. Culpa corrupti iusto dolor. Similique quibusdam eveniet quae
							deleniti architecto modi natus, quos ducimus! Repudiandae reiciendis totam sequi
							veniam necessitatibus, magni harum. Lorem ipsum, dolor sit amet consectetur
							adipisicing elit. Culpa corrupti iusto dolor. Similique quibusdam eveniet quae
							deleniti architecto modi natus, quos ducimus! Repudiandae reiciendis totam sequi
							veniam necessitatibus, magni harum. Lorem ipsum, dolor sit amet consectetur
	...
	<p>
		Lorem ipsum, dolor sit...
			...
			<div class="space-y-4">
				<h2>Dividers</h2>
				<p>
					Native <code>hr</code> horizontal rule elements respect your theme settings automatically.
					Use border size to adjust the width.
				</p>
				<DocsPreview background="neutral">
					<svelte:fragment slot="bcu-previewer-preview">
...
<hr class="!border-t-8 !border-double" />
				...
				<p>
					Divide columns with the <code>.divider-vertical</code> class. You can apply it with a
					<code>span</code>
					tag. Adjust the
					<a href="https://tailwindcss.com/docs/height" target="_blank" rel="noreferrer">height</a> as
					desired.
				</p>
				<DocsPreview background="neutral">
					<svelte:fragment slot="bcu-previewer-preview">
