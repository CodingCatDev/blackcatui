<script lang="ts">
	...
	const settings: DocsShellSettings = {
		...
		dependencies: [
			{ label: 'Tailwind Gradients', url: 'https://tailwindcss.com/docs/gradient-color-stops' }
		]
	};
</script>
...
`}
	...
	<svelte:fragment slot="usage">
		...
		<section class="space-y-4">
			<h2>Using @apply</h2>
			<p>
				Create a new class using <code>@apply</code> in your <code>app.postcss</code> global stylesheet.
