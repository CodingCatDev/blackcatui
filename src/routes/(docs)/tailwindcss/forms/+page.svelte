...
<label class="label">
	...
	<textarea class="textarea" rows="4" placeholder="Lorem ipsum dolor sit amet consectetur adipisicing elit." />
		...
		<p>
			Unlike other UI libraries, Skeleton relies heavily on native HTML form fields. This provides
			the best user experience and optimal accessibility. Note that form field styling is opt-in,
			which means a class must be applied to each element.
		</p>
		<!-- Install the Plugin -->
			...
			<div class="flex-auto space-y-4">
				...
				<p>
					Prepend the <a
						...
						target="_blank"
						rel="noreferrer">Tailwind Forms plugin</a
					>
					to your
	...
	<input class="input" type="text" bind:value={colorValue} readonly tabindex="-1" />
		...
		<section class="space-y-4">
			...
			<ul class="space-y-2 list-disc list-inside">
				...
				<li>
					Descriptive segments (on either side) allow for <code>div</code>, <code>button</code>, and
					anchor (<code>a</code>) elements.
				</li>
				<li>
					The <code>.input-group-divider</code> class applies vertical divider lines.
				</li>
				<li>
					The <code>.input-group-shim</code> class applies subtle shading to a segment, to draw more
					attention.
				</li>
			</ul>
			<DocsPreview background="neutral">
...
<div class="input-group input-group-divider grid-cols-[auto_1fr_auto]">
	...
	<button class="variant-filled-secondary">Submit</button>
		...
		<section class="space-y-4">
			<h2>Variants</h2>
			<p>
				Skeleton includes a forms variant inspired by <a
					href="https://m3.material.io/"
					target="_blank"
					rel="noreferrer">Material Design.</a
		...
		<section class="space-y-4">
			...
			<p>
				Skeleton provides a set of classes for indicating form validation. These must come last in a
				group of class values. They are compatible with the variant above.
			</p>
			<DocsPreview background="neutral">
				<svelte:fragment slot="bcu-previewer-preview">
					<div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
		...
		<section class="space-y-4">
			...
			<p>
				Please be aware that not all native HTML form fields work consistently across browsers or
				operating systems. We strongly recommend cross-device/OS/browser testing to ensure
				compability for your target audience.
			</p>
		</section>
	</section>
</DocsShell>
