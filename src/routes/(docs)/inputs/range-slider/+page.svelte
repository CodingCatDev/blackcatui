<script lang="ts">
	...
	// Components
	import RangeSlider from '$lib/components/Inputs/RangeSlider/RangeSlider.svelte';
	import CodeBlock from '$lib/components/DataDisplay/CodeBlock/CodeBlock.svelte';
	// Sveld
	import sveldRangeSlider from '$lib/components/Inputs/RangeSlider/RangeSlider.svelte?raw&sveld';
	...
	const settings: DocsShellSettings = {
		...
		keyboard: [
			[
				'<kbd>Right Arrow</kbd> or <kbd>Up Arrow</kbd>',
				'Increase the value of the slider by one step.'
			],
			[
				'<kbd>Left Arrow</kbd> or <kbd>Down Arrow</kbd>',
	...
	<div class="flex items-center justify-between">
		...
		<section class="space-y-4">
			...
			<div class="grid grid-cols-2 gap-4 text-center md:grid-cols-4">
				...
				<div class="p-2 bcu-card variant-filled-warning">
					<h4>Safari</h4>
					<span>Partial</span>
				</div>
				<div class="p-2 bcu-card variant-filled-success">
