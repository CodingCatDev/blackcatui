<script lang="ts">
	...
	import type { PopupSettings } from '$lib/components/Utilities/Popup/types';
...
<div class="docs-themer space-y-4">
	<div class="card variant-glass p-4 flex justify-between items-center">
		...
		<Switch name="preview" bind:checked={$storePreview} on:change={onPreviewToggle} />
	</div>
	<div class="grid grid-cols-2 gap-4">
		...
		<section class="card col-span-2">
			...
			<header class="p-4 col-span-2 flex justify-between items-center">
				...
				<button
					class="bcu-button variant-ghost-surface"
					on:click={randomize}
		...
		<section class="card variant-glass p-4 space-y-8 col-span-2 lg:col-span-1">
			...
			<div class="grid grid-cols-3 gap-4">
				<button class="bcu-button variant-filled-primary">primary</button>
				<button class="bcu-button variant-filled-secondary">secondary</button>
				<button class="bcu-button variant-filled-tertiary">tertiary</button>
				<button class="bcu-button variant-filled-success">success</button>
				<button class="bcu-button variant-filled-warning">warning</button>
				<button class="bcu-button variant-filled-error">error</button>
			</div>
			<hr class="opacity-50" />
			<!-- Progress Bars -->
			...
			<div class="grid grid-cols-4 gap-4 place-items-center">
				<span class="bcu-badge variant-filled-surface">surface</span>
				<span class="bcu-badge variant-filled-primary">primary</span>
				<span class="bcu-badge variant-filled-secondary">secondary</span>
				<span class="bcu-badge variant-filled-tertiary">tertiary</span>
				<span class="bcu-badge bcu-badge-glass">glass</span>
				<span class="bcu-badge variant-filled-success">success</span>
				<span class="bcu-badge variant-filled-warning">warning</span>
				<span class="bcu-badge variant-filled-error">error</span>
			</div>
			<hr class="opacity-50" />
			<!-- Slide Toggles -->
			<div class="grid grid-cols-4 gap-4 place-items-center">
				<Switch name="exampeSliderThree" checked />
				<Switch name="exampeSliderOne" active="bg-primary-500" checked />
				<Switch name="exampeSliderTwo" active="bg-secondary-500" checked />
				<Switch name="exampeSliderFour" active="bg-tertiary-500" checked />
			</div>
		</section>
		...
		<footer class="col-span-2 space-y-4">
			...
			<div class="card variant-glass p-4 text-center">
				<!-- prettier-ignore -->
				<button class="bcu-button bcu-button-lg variant-filled-primary font-bold" on:click={() => { showThemeCSS = !showThemeCSS; }} disabled={!$storePreview}>
