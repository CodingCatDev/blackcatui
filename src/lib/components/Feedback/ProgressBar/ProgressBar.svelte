...
<!-- Track -->
<div
	class="bcu-progress-bar {classesTrack}"
	data-testid="bcu-progress-bar"
	role="progressbar"
...
>
	<!-- Meter -->
	<div
		class="bcu-progress-bar-meter {classesMeter} {classesMeter}"
		style:width="{indeterminate ? 100 : fillPercent}%"
	/>
</div>
