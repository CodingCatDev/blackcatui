...
<!-- prettier-ignore -->
<div class="bcu-paginator {classesBase}" data-testid="paginator">
	<!-- Select Amount -->
	<label class="bcu-paginator-label {classesLabel}">
	...
	<!-- Details -->
	<span class="bcu-paginator-details {classesPageText}">
	...
	<!-- Arrows -->
	<div class="bcu-paginator-arrows space-x-2">
