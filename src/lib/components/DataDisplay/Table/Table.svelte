<script lang="ts">
	...
	import { tableA11y } from '$lib/components/Utilities/DataTable/DataTable';
	...
	export let element: CssClasses = 'bcu-table';
...
<div class="bcu-table-container {classesBase}">
	<!-- Table -->
	<!-- prettier-ignore -->
	<table
		class="{classesTable}"
	...
	>
		...
		<!-- Head -->
		<thead class="bcu-table-head {regionHead}">
			<tr>
		...
		<!-- Body -->
		<tbody class="bcu-table-body {regionBody}">
		...
		<!-- Foot -->
		{#if source.foot}
			<tfoot class="bcu-table-foot {regionFoot}">
				<tr>
