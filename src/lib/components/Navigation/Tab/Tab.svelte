<script lang="ts">
	// Slots
	/**
	 * @slot bcu-tab-lead - Provides a leading position, which can be used for icons.
	 */
...
>
	...
	<!-- Interface -->
	<div class="bcu-tab-interface {classesInterface}">
		{#if $$slots['bcu-tab-lead']}<div class="bcu-tab-lead"><slot name="bcu-tab-lead" /></div>{/if}
		<div class="bcu-tab-label"><slot /></div>
	</div>
</label>
